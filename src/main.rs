...
struct GreekKeyConfig {
    key_unit_length: i32,
    width_units: i32,
    height_units: i32,
    key_pattern_length: i32,
}

impl GreekKeyConfig {
    fn new(key_unit_length: i32, width_units: i32, height_units: i32) -> Self {
        Self {
            key_unit_length,
            width_units,
            height_units,
    ...
    fn get_canvas_size(&self) -> (i32, i32) {
    ...
    fn get_inner_frame_size(&self) -> (i32, i32, i32, i32) {
